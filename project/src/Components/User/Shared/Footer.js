                ...
                <div className ="row g-5">
                    <div className ="col-md-6 col-lg-6 col-xl-3">
                        <div className ="footer-item d-flex flex-column">
                            ...
                            <a href=""><i className ="fas fa-home me-2"></i> Indore,Madhya Pradesh,India</a>
                            <a href=""><i className ="fas fa-envelope me-2"></i> ernsingh@gmail.com</a>
                            <a href=""><i className ="fas fa-phone me-2"></i> 8236844284</a>
